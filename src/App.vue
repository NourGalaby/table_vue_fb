<template>
  <div id="app">
    ...
    <br> -->
    <button class="accordion2" v-on:click="tggleacc">Advanced Filters</button>
    <div class="panel">
      <div class="filterbar" id="filter1">
      ...
      <div class="filterbar" id="filter2">
      ...
      <div class="filterbar" id="filter3">
      ...
      <div class="filterbar" id="filter4">
